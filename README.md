...
- Baseline group membership screenshots (all 5 original users, pre-lifecycle events)
- Elena Vasquez — Groups tab (Joiner, clean result)
- Marcus Webb — Groups tab (Mover, leftover access finding)
- Tom Ellison — Account status + Groups tab (Leaver, deprovisioned after delay)
- Full Users list — final state, all 7 users
